...
def matrix_factorization(R, K, steps=70, alpha=0.002, beta=0.02):
...
connection_counts = predictions.sum(axis=1)  # Sum of predicted connections per user
most_connected = pd.DataFrame({'Email': email, 'Connections': connection_counts})
most_connected = most_connected.sort_values(by='Connections', ascending=False)

print("\nMost Connected Users:")
print(most_connected.head(10))  # Show top users with the most predicted connections